---
layout: post
title: "Win vs Delta4Chess (341)"
date: 2026-04-25 14:00:00 +1000
---
...
[View on Chess.com](https://www.chess.com/game/167794260714)

<iframe id="14971001" allowtransparency="true" frameborder="0" style="width:100%;border:none;" src="https://www.chess.com/emboard?id=14971001"></iframe><script nonce="chesscom-diagram">window.addEventListener("message",e=>{e['data']&&"14971001"===e['data']['id']&&document.getElementById(`${e['data']['id']}`)&&(document.getElementById(`${e['data']['id']}`).style.height=`${e['data']['frameHeight']+37}px`)})</script>
...
<figure>
  <img src="{{ '/assets/images/2026-04-25-game1/move12.png' | relative_url }}" alt="After 6...Bxf6">
  <figcaption>After 6...Bxf6: Dark-squared bishop preserved as key defender.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-25-game1/move20.png' | relative_url }}" alt="After 10...Bxe5">
  <figcaption>After 10...Bxe5: Bishop on e5 eyeing h2.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-25-game1/move23.png' | relative_url }}" alt="After 12. Qxh6">
  <figcaption>After 12. Qxh6: Queen invades. No concrete threat yet.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-25-game1/move25.png' | relative_url }}" alt="After 13. Qxg6+">
...
<figure>
  <img src="{{ '/assets/images/2026-04-25-game1/move28.png' | relative_url }}" alt="After 14...Qf8">
  <figcaption>After 14...Qf8: Setting up Rxg2+ with a discovered attack on the queen.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-25-game1/move30.png' | relative_url }}" alt="After 15...Rxg2+">
  <figcaption>After 15...Rxg2+: Brilliant. Rook sacrifice to win the queen.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-25-game1/move32.png' | relative_url }}" alt="After 16...Qxh6">
