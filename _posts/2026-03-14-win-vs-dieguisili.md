---
layout: post
title: "Win vs Dieguisili (885)"
date: 2026-03-14 14:00:00 +1000
---
...
[View on Chess.com](https://www.chess.com/game/daily/942093433?move=0)

<iframe id="14763241" allowtransparency="true" frameborder="0" style="width:100%;border:none;" src="https://www.chess.com/emboard?id=14763241"></iframe><script nonce="chesscom-diagram">window.addEventListener("message",e=>{e['data']&&"14763241"===e['data']['id']&&document.getElementById(`${e['data']['id']}`)&&(document.getElementById(`${e['data']['id']}`).style.height=`${e['data']['frameHeight']+37}px`)})</script>
...
<figure>
  <img src="{{ '/assets/images/2026-03-14-game1/move12.png' | relative_url }}" alt="After 6...O-O">
  <figcaption>After 6...O-O: Castled with a solid defensive barrier. Dark-squared bishop blocked in though.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-03-14-game1/move24.png' | relative_url }}" alt="After 12...bxc6">
  <figcaption>After 12...bxc6: Bishop pair vs knight pair. Doubled pawns on f and c files.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-03-14-game1/move28.png' | relative_url }}" alt="After 14...Qg5">
  <figcaption>After 14...Qg5: Queen swings to the kingside. Not enough supporting pieces for the attack.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-03-14-game1/move34.png' | relative_url }}" alt="After 17...Bc8">
  <figcaption>After 17...Bc8: Bishop two squares from the knight, blocking its advance.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-03-14-game1/move48.png' | relative_url }}" alt="After 24...f5">
  <figcaption>After 24...f5: Pushing to open up space for the dark-squared bishop.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-03-14-game1/move56.png' | relative_url }}" alt="After 28...Bxc5">
  <figcaption>After 28...Bxc5: Traded the dark-squared bishop for a knight. White's rooks are dominant.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-03-14-game1/move72.png' | relative_url }}" alt="After 36...Bxf5">
  <figcaption>After 36...Bxf5: Bishop vs knight. Material equal but it's a race to promote.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-03-14-game1/move88.png' | relative_url }}" alt="After 44...Kd5">
  <figcaption>After 44...Kd5: White has +3.3 here. Kg4-Ng4-Nh6 would trap the bishop on h7.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-03-14-game1/move104.png' | relative_url }}" alt="After 52...c1=Q+">
  <figcaption>After 52...c1=Q+: Promotion with check. Bishop on the adjacent diagonal to the queen.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-03-14-game1/move120.png' | relative_url }}" alt="After 60...Qg2#">
  <figcaption>After 60...Qg2#: King and queen deliver the checkmate in the corner.</figcaption>
</figure>
...
- [Attacking the King](https://www.chess.com/article/view/attacking-the-king)
