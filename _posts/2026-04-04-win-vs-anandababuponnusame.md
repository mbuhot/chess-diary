---
layout: post
title: "Win vs AnandababuPonnusame (751)"
date: 2026-04-04 14:00:00 +1000
---
...
[View on Chess.com](https://www.chess.com/game/166834402184?action=createLiveChallenge&move=1)

<iframe id="14843453" allowtransparency="true" frameborder="0" style="width:100%;border:none;" src="https://www.chess.com/emboard?id=14843453"></iframe><script nonce="chesscom-diagram">window.addEventListener("message",e=>{e['data']&&"14843453"===e['data']['id']&&document.getElementById(`${e['data']['id']}`)&&(document.getElementById(`${e['data']['id']}`).style.height=`${e['data']['frameHeight']+37}px`)})</script>
...
<figure>
  <img src="{{ '/assets/images/2026-04-04-game1/move7.png' | relative_url }}" alt="After 4. Nbd2">
  <figcaption>After 4. Nbd2: Check blocked. Knight heading for the kingside.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-04-game1/move13.png' | relative_url }}" alt="After 7. exd4">
  <figcaption>After 7. exd4: Centre recaptured with the e-pawn. E-file now open for the rook.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-04-game1/move19.png' | relative_url }}" alt="After 10. Be2">
  <figcaption>After 10. Be2: Discovered attack ready. When the knight moves to e5, the bishop hits the queen.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-04-game1/move26.png' | relative_url }}" alt="After 13...Qxf4">
  <figcaption>After 13...Qxf4: The blunder. Queen sits right in front of the rook on f1.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-04-game1/move27.png' | relative_url }}" alt="After 14. Rxf4">
  <figcaption>After 14. Rxf4: Queen captured. Black tries Nd5 attacking the rook.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-04-game1/move29.png' | relative_url }}" alt="After 15. Nxd6+">
  <figcaption>After 15. Nxd6+: Bishop captured with check. Up a queen and two pieces for two pawns.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-04-game1/move33.png' | relative_url }}" alt="After 17. Rxf7+">
  <figcaption>After 17. Rxf7+: Rook crashes through with check. No escape.</figcaption>
</figure>

<figure>
  <img src="{{ '/assets/images/2026-04-04-game1/move35.png' | relative_url }}" alt="After 18. Nd6+">
  <figcaption>After 18. Nd6+: Knight returns to d6. King forced to d8.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-04-game1/move37.png' | relative_url }}" alt="After 19. Rxd7#">
  <figcaption>After 19. Rxd7#: Checkmate. Rook and knight deliver the final blow.</figcaption>
</figure>
