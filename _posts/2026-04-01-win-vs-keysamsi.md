...
<iframe id="14830927" allowtransparency="true" frameborder="0" style="width:100%;border:none;" src="https://www.chess.com/emboard?id=14830927"></iframe><script nonce="chesscom-diagram">window.addEventListener("message",e=>{e['data']&&"14830927"===e['data']['id']&&document.getElementById(`${e['data']['id']}`)&&(document.getElementById(`${e['data']['id']}`).style.height=`${e['data']['frameHeight']+37}px`)})</script>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move8.png' | relative_url }}" alt="After 4...O-O">
  <figcaption>After 4...O-O: King's Indian setup complete. Waiting for the right time to play e5.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move12.png' | relative_url }}" alt="After 6...e5">
  <figcaption>After 6...e5: Challenging White's big centre. Pawns on e4, d4, and c4.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move16.png' | relative_url }}" alt="After 8...Rxd8">
  <figcaption>After 8...Rxd8: Queens off the board. Calm position.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move18.png' | relative_url }}" alt="After 9...Nbd7">
  <figcaption>After 9...Nbd7: Double fianchetto developing. Knight supports f6 and e5.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move26.png' | relative_url }}" alt="After 13...Rxd1+">
  <figcaption>After 13...Rxd1+: Rook trade to escape the pin. Knight on c5 eyes e4.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move28.png' | relative_url }}" alt="After 14...Ncxe4">
  <figcaption>After 14...Ncxe4: Knight on e4 defended by bishop on b7 and knight on f6.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>After 15...h6: Kicking the bishop. Trade or retreat?</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move32.png' | relative_url }}" alt="After 16...Nxc3">
  <figcaption>After 16...Nxc3: Doubled pawns on the c-file. Knight also attacks the rook on d1.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move42.png' | relative_url }}" alt="After 21...Nxc3">
  <figcaption>After 21...Nxc3: Rook and knight each. Queenside pawns ready to march.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move56.png' | relative_url }}" alt="After 28...Rxc4">
  <figcaption>After 28...Rxc4: Pawn grabbed. Clear path for the b-pawn to promote.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move62.png' | relative_url }}" alt="After 31...Nd1+">
  <figcaption>After 31...Nd1+: Knight fork. King and rook on the same rank.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move74.png' | relative_url }}" alt="After 37...b1=Q">
  <figcaption>After 37...b1=Q: Promotion. An extra queen and rook against a lone knight.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-01-game1/move84.png' | relative_url }}" alt="After 42...Qh2#">
  <figcaption>After 42...Qh2#: Checkmate with queen, knight, and pawn.</figcaption>
</figure>
...
- [Extra Pawns in the Endgame: How to Win?](https://www.chess.com/article/view/extra-pawns-in-endgame---how-to-win)
