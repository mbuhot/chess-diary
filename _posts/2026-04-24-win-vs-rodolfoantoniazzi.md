---
layout: post
title: "Win vs RodolfoAntoniazzi (1115)"
date: 2026-04-24 14:00:00 +1000
---
...
<iframe id="14963547" allowtransparency="true" frameborder="0" style="width:100%;border:none;" src="https://www.chess.com/emboard?id=14963547"></iframe><script nonce="chesscom-diagram">window.addEventListener("message",e=>{e['data']&&"14963547"===e['data']['id']&&document.getElementById(`${e['data']['id']}`)&&(document.getElementById(`${e['data']['id']}`).style.height=`${e['data']['frameHeight']+37}px`)})</script>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game1/move7.png' | relative_url }}" alt="After 4. Bd3">
  <figcaption>After 4. Bd3: g2 is undefended. The bishop on b7 sees it.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game1/move10.png' | relative_url }}" alt="After 5...Bxh1">
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game1/move17.png' | relative_url }}" alt="After 9. Bg5">
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game1/move20.png' | relative_url }}" alt="After 10...Nxe4+">
  <figcaption>After 10...Nxe4+: Removing the guard of g5.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game1/move22.png' | relative_url }}" alt="After 11...Bxg5">
  <figcaption>After 11...Bxg5: Bishop taken. Up 9 points.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game1/move25.png' | relative_url }}" alt="After 13. Qh5">
  <figcaption>After 13. Qh5: Threatens Qxh7#. Must defend.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game1/move28.png' | relative_url }}" alt="After 14...f5">
  <figcaption>After 14...f5: Fork. Queen and bishop both attacked.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game1/move50.png' | relative_url }}" alt="After 25...Nd2+">
  <figcaption>After 25...Nd2+: Mate in 6. White resigns.</figcaption>
</figure>
