...
[View on Chess.com](https://www.chess.com/game/164887351700)

<iframe id="14604991" allowtransparency="true" frameborder="0" style="width:100%;border:none;" src="https://www.chess.com/emboard?id=14604991"></iframe><script nonce="chesscom-diagram">window.addEventListener("message",e=>{e['data']&&"14604991"===e['data']['id']&&document.getElementById(`${e['data']['id']}`)&&(document.getElementById(`${e['data']['id']}`).style.height=`${e['data']['frameHeight']+37}px`)});</script>
...
<figure>
  <img src="{{ '/assets/images/2026-02-19/move08.png' | relative_url }}" alt="After 4...Bb4">
  <figcaption>After 4...Bb4: Black pins the knight to the king. White decides to ignore it and continue development.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-02-19/move18.png' | relative_url }}" alt="After 9...dxe4">
  <figcaption>After 9...dxe4: The bishop trade. White loses the light-squared bishop but eliminates Black's knight.</figcaption>
</figure>

<figure>
  <img src="{{ '/assets/images/2026-02-19/move23.png' | relative_url }}" alt="After 12. Ne5">
  <figcaption>After 12. Ne5: The knight is back on its ideal square after being kicked out and hopping back in.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-02-19/move35.png' | relative_url }}" alt="After 18. exf4">
  <figcaption>After 18. exf4: The pawn attacks Black's queen on g5. Black takes with the rook instead of moving the queen.</figcaption>
</figure>

<figure>
  <img src="{{ '/assets/images/2026-02-19/move39.png' | relative_url }}" alt="After 20. Rxf4">
  <figcaption>After 20. Rxf4: White is up a full rook after the exchange.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-02-19/move47.png' | relative_url }}" alt="After 24. h5">
  <figcaption>After 24. h5: Pawns marching forward. White's rooks are doubled on the f-file, ready to infiltrate.</figcaption>
</figure>

<figure>
  <img src="{{ '/assets/images/2026-02-19/move61.png' | relative_url }}" alt="Checkmate: R6h7#">
  <figcaption>31. R6h7#: Checkmate. The doubled rooks on the 7th and 8th ranks seal the deal.</figcaption>
</figure>
...
- [Colle System: Rubinstein Opening](https://www.chess.com/openings/Colle-System-Rubinstein-Opening) - The opening I played as White
- [How To Convert An Advantage](https://www.chess.com/article/view/how-to-convert-chess-advantage) - Converting a material advantage into a win
