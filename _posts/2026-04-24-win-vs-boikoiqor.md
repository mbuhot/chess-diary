---
layout: post
title: "Win vs BoikoIqor (720)"
date: 2026-04-24 18:00:00 +1000
---
...
[View on Chess.com](https://www.chess.com/game/167749087000)

<iframe id="14964981" allowtransparency="true" frameborder="0" style="width:100%;border:none;" src="https://www.chess.com/emboard?id=14964981"></iframe><script nonce="chesscom-diagram">window.addEventListener("message",e=>{e['data']&&"14964981"===e['data']['id']&&document.getElementById(`${e['data']['id']}`)&&(document.getElementById(`${e['data']['id']}`).style.height=`${e['data']['frameHeight']+37}px`)})</script>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game3/move6.png' | relative_url }}" alt="After 3...Bb4+">
  <figcaption>After 3...Bb4+: Horwitz Defence. Early queen and bishop aggression.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game3/move9.png' | relative_url }}" alt="After 5. Bd3">
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game3/move19.png' | relative_url }}" alt="After 10. Bb2">
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game3/move23.png' | relative_url }}" alt="After 12. Bxd4">
  <figcaption>After 12. Bxd4: Bishops traded. Black has a passed d-pawn.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game3/move27.png' | relative_url }}" alt="After 14. e5">
  <figcaption>After 14. e5: Attacking the queen. Two knights support the pawn.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game3/move29.png' | relative_url }}" alt="After 15. Nfxe5">
  <figcaption>After 15. Nfxe5: Knight recaptures. Up a full piece.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game3/move31.png' | relative_url }}" alt="After 16. f4">
  <figcaption>After 16. f4: Defends e5. Discovery threat on the f-file.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game3/move35.png' | relative_url }}" alt="After 18. Ne5">
  <figcaption>After 18. Ne5: Knight back on e5. Dominant central outpost.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-24-game3/move39.png' | relative_url }}" alt="After 20. Rae1">
  <figcaption>After 20. Rae1: Heavy pieces lined up on the e-file. Black resigns.</figcaption>
</figure>
