---
layout: post
title: "Win vs the_dices (511)"
date: 2026-04-11 14:00:00 +1000
---
...
[View on Chess.com](https://www.chess.com/game/live/167151399992)

<iframe id="14895581" allowtransparency="true" frameborder="0" style="width:100%;border:none;" src="https://www.chess.com/emboard?id=14895581"></iframe><script nonce="chesscom-diagram">window.addEventListener("message",e=>{e['data']&&"14895581"===e['data']['id']&&document.getElementById(`${e['data']['id']}`)&&(document.getElementById(`${e['data']['id']}`).style.height=`${e['data']['frameHeight']+37}px`)})</script>
...
<figure>
  <img src="{{ '/assets/images/2026-04-11-game1/move9.png' | relative_url }}" alt="After 5. b4">
  <figcaption>After 5. b4: King's Indian setup. White pushing queenside pawns.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-11-game1/move18.png' | relative_url }}" alt="After 9...f5">
  <figcaption>After 9...f5: Interesting pawn symmetry along the long diagonal.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-11-game1/move24.png' | relative_url }}" alt="After 12...f4">
  <figcaption>After 12...f4: Four pawns in a row from c7 to f4.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-11-game1/move30.png' | relative_url }}" alt="After 15...gxf3">
  <figcaption>After 15...gxf3: Knight captured. Pawn threatens the bishop and rook.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-11-game1/move31.png' | relative_url }}" alt="After 16. e6+">
  <figcaption>After 16. e6+: Discovered check from the bishop on b2.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-11-game1/move35.png' | relative_url }}" alt="After 18. dxe8=Q">
  <figcaption>After 18. dxe8=Q: White promotes. But exf1=Q+ was available first.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-11-game1/move46.png' | relative_url }}" alt="After 23...Bg4">
  <figcaption>After 23...Bg4: Bishop attacks the queen. Only one safe square.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/images/2026-04-11-game1/move48.png' | relative_url }}" alt="After 24...Bxd1">
  <figcaption>After 24...Bxd1: Queen blundered and captured.</figcaption>
</figure>
...
- [Flagging](https://www.chess.com/terms/flagging-chess)
- [The Art of Time Management](https://www.chess.com/article/view/the-art-of-time-management)
